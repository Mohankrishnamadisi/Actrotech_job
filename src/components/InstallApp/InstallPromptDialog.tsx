...
export const InstallPromptDialog: React.FC<Props> = ({ open, onClose, onInstall }) => {
  return (
    <Dialog open={open} onClose={onClose} maxWidth="xs" fullWidth>
      <DialogTitle>Install Jobpoyt App</DialogTitle>
      <DialogContent sx={{ pt: 1.5 }}>
        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
          <Box component="img" src="/Jobpoyt.png" alt="Jobpoyt" sx={{ width: 64, height: 64, borderRadius: 2 }} />
          <Box>
            <Typography variant="body1" sx={{ fontWeight: 700 }}>Install Jobpoyt App</Typography>
